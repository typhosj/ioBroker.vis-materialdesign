...
// ...and forces `.mdc-list-item__graphic{width:24px;height:24px}` which clamps larger list icons
// (listImageHeight, e.g. 60px SVGs) down to 24px. Let the icon size itself (renderIcon sets width/height).
const listCss = '.materialdesign-list.materialdesign-widget .mdc-list-item{min-height:var(--materialdesign-list-item-height,48px)!important;height:auto!important}'
    + '.materialdesign-list .mdc-list-item__graphic{width:auto!important;height:auto!important;overflow:visible}';
