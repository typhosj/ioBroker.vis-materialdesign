...
// The legacy materialdesign bundle ships `.materialdesign-widget .mdc-list-item{height:auto!important;min-height:40px!important}`
// which overrides our inline row height. Counter it with a more specific, later rule driven by a CSS var.
const listCss = '.materialdesign-list.materialdesign-widget .mdc-list-item{min-height:var(--materialdesign-list-item-height,48px)!important;height:auto!important}';

export default class MaterialDesignList extends VisWidget {
    static getWidgetInfo(): RxWidgetInfo { return { ...createInfo('tplVis2-materialdesign-List', 'List', attrs), visPrev: '<img src="widgets/materialdesign/img/prev_list.png"></img>', visDefaultStyle: { width: 400, height: 270 } }; }
