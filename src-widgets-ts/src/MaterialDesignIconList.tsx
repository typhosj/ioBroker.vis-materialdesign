...
const attrs: RxWidgetInfo['visAttrs'] = [
    ...
    { name: 'listItemData', fields: [
        ...
        { name: 'countListItems', label: 'countListItems', type: 'number', default: 1, onChange: async (_field, data, changeData) => changeData({ ...data, lastListItemIndex: Math.max(0, Math.floor(Number(data.countListItems) || 1) - 1) }) },
