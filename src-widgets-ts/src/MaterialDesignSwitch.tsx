...
export default class MaterialDesignSwitch extends VisWidget {
    constructor(props: VisRxWidgetProps) {
        super(props);
    }

    static getWidgetInfo(): RxWidgetInfo {
        return createInfo('tplMaterialDesignSwitch', 'Switch', commonAttrs);
    }

    getWidgetInfo(): RxWidgetInfo {
        return MaterialDesignSwitch.getWidgetInfo();
    }
    ...
    renderWidgetBody(props: RenderProps): React.JSX.Element {
        ...
        return card(
            <label style={{ alignItems: 'center', cursor: 'pointer', display: 'inline-flex', gap: 8 }}>
                ...
                <span>{data.label || data.oid || 'Switch'}</span>
            </label>,
        );
    }
}
