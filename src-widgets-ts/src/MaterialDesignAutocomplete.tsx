...
export default class MaterialDesignAutocomplete extends MaterialDesignSelect {
    static getWidgetInfo(): RxWidgetInfo {
        ...
        return { ...select, id: 'tplVis2-materialdesign-Autocomplete', visName: 'Autocomplete', visAttrs: attrs, visPrev: '<img src="widgets/materialdesign/img/prev_autocomplete.png"></img>' };
    }
